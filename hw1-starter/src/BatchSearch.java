...
public class BatchSearch {
	...
	public static void main(String[] args) throws Exception {
		...
		if (simfn == null) {
			System.out.println(usage);
			System.out.println("Supported similarity functions:\ndefault: ClassicSimilarity (tfidf)");
	 ...
	 */
	public static long doBatchSearch(BufferedReader in, IndexSearcher searcher, String qid, Query query, String runtag)	 
			throws IOException {
